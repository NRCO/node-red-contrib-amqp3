...
module.exports = function (RED) {
    ...
    function AmqpServer(n) {
        ...
        node.buildUrl = function () {
            var credentials = node.credentials, protocol = node.useTls ? "amqps://" : "amqp://", credentials = credentials.user ? credentials.user + ":" + credentials.password + "@" : "", vhost = node.vhost ? "/" + node.vhost : "";
